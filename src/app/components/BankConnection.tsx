...
export function BankConnection({
  ...
  return (
    <div className="space-y-4">
      {connectedBank ? (
        <Card className="bg-gradient-to-r from-green-50 to-emerald-50 border-green-200 dark:from-emerald-950/30 dark:to-green-950/20 dark:border-emerald-800">
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="h-12 w-12 rounded-full bg-white dark:bg-zinc-900 flex items-center justify-center text-2xl shadow-sm border border-border">
                  🏦
                </div>
                <div>
                  <div className="flex items-center gap-2">
                    <CardTitle className="text-base text-foreground">{connectedBank}</CardTitle>
          ...
          <CardContent className="space-y-2">
            <Button
              onClick={handleSync}
              variant="outline"
              className="w-full h-11 bg-white dark:bg-zinc-900 dark:hover:bg-zinc-800"
              disabled={isSyncing}
            >
        ...
        <Card className="border-2 border-dashed">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex items-center gap-2 p-3 bg-blue-50 border border-blue-200 rounded-xl dark:bg-blue-950/30 dark:border-blue-800">
      ...
      <Card className="bg-gradient-to-r from-purple-50 to-blue-50 border-purple-200 dark:from-purple-950/30 dark:to-blue-950/30 dark:border-purple-800">
        <CardHeader className="pb-3">
          <CardTitle className="text-base text-foreground">About Open Banking</CardTitle>
        </CardHeader>

        <CardContent className="space-y-2">
          <div className="flex items-start gap-2">
            <CheckCircle2 className="h-4 w-4 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5" />
            <p className="text-xs text-foreground">Secure, read-only access to your transactions</p>
          </div>

          <div className="flex items-start gap-2">
            <CheckCircle2 className="h-4 w-4 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5" />
            <p className="text-xs text-foreground">Automatically categorizes your spending</p>
          </div>

          <div className="flex items-start gap-2">
            <CheckCircle2 className="h-4 w-4 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5" />
            <p className="text-xs text-foreground">Real-time budget tracking</p>
          </div>

          <div className="flex items-start gap-2">
            <CheckCircle2 className="h-4 w-4 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5" />
            <p className="text-xs text-foreground">Bank-grade encryption & security</p>
          </div>
        </CardContent>
      </Card>
    </div>
